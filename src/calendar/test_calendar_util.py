...
import boto3
import os
from .calendar_util import get_google_oauth_token_low_level, get_availability_low_level as get_availability
...
def main():
    ...
    all_tests_passed = oauth_success and availability_not_found_success
