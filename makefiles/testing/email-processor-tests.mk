...
.PHONY: test-email-processor-e2e test-email-processor-e2e-all test-email-processor-case-1-share-availability test-email-processor-case-2-book-event
...
test-email-processor-e2e-all: test-email-processor-case-1-share-availability test-email-processor-case-2-book-event ## Run all email processor tests in sequence
