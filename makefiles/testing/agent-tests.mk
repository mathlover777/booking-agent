...
.PHONY: test-agent test-agent-calendar-failures test-agent-end-to-end test-agent-all test-case-1-no-agents test-case-2-agent-not-registered test-case-3-owner-not-in-conversation test-case-4-missing-user-email test-case-5-availability test-case-6-book-event test-case-7-cancel-event test-case-8-llm-disambiguation
...
test-agent-calendar-failures: ## Test all calendar owner resolution failure cases (deterministic)
...
test-agent-end-to-end: ## Test all end-to-end success flows (requires Google Calendar)
...
test-agent-all: test-agent-calendar-failures test-agent-end-to-end ## Run all agent tests in sequence

# ---------------------------------------------------------------------------
# Individual test cases for calendar owner resolution failures ---------------
# ---------------------------------------------------------------------------

test-case-1-no-agents: ## Test Case 1: No booking agents found
...
test-case-2-agent-not-registered: ## Test Case 2: Booking agent not registered
...
test-case-3-owner-not-in-conversation: ## Test Case 3: Calendar owner not in conversation
...
test-case-4-missing-user-email: ## Test Case 4: Missing user_email field
...
test-case-5-availability: ## Test Case 5: Share availability (end-to-end)
...
test-case-6-book-event: ## Test Case 6: Book event (end-to-end)
...
test-case-7-cancel-event: ## Test Case 7: Cancel event (end-to-end)
...
test-case-8-llm-disambiguation: ## Test Case 8: Multiple agents, LLM disambiguation
